import type { NavItem, Skill, Work, LearningEntry, CharacterStats } from '@/types'
...
// ─── Dialog messages ──────────────────────────────────────────────────────────
export const PAGE_DIALOGS: Record<string, { speaker: string; message: string }> = {
  about: {
    speaker: '▸ GUIDE',
    message: 'ここは【About】のページ。\n勇者の素性と歩んできた冒険の歴史が刻まれている。',
  },
  skills: {
    speaker: '▸ STATUS',
    message: '【Skills】のページへようこそ。\n習得した魔法と技術の一覧を確認できる。',
  },
  works: {
    speaker: '▸ BARD',
    message: '【Works】のページじゃ。\n数々の冒険で築いた制作物の記録が眠っている。',
  },
  contact: {
    speaker: '▸ INN KEEPER',
  ...
  learning: {
    speaker: '▸ SAGE',
    message: '【Learning】の書庫へようこそ。\n旅の中でキャッチアップした知識の備忘録じゃ。\n新しい呪文を覚えたら、ここに記せ。',
  },
  demo: {
    speaker: '▸ RESEARCHER',
    message: '【DEMO β】ページへ踏み込んだか…\n未完成の実験場だ。足元に気をつけろ！',
  },
}
...
export const WORKS: Work[] = [
  {
    tag: 'WEB APP',
    title: 'DungeonCMS',
    description: '高速な管理画面CMSシステム。Next.js + Prisma + PostgreSQL構成。',
    stars: 4,
...
export const LEARNING_ENTRIES: LearningEntry[] = [
  {
    ...
    summary: 'Computer Use API が正式リリース。ブラウザ操作・ファイル操作を自律的に行えるエージェント機能。Vision精度も大幅向上。',
  ...
  },
  {
    ...
    summary: 'Partial Prerendering (PPR) が安定版に。静的+動的コンテンツをシームレスに混在させつつ初期表示を高速化できる。',
  ...
  },
  {
    ...
    summary: 'Node.js比で平均3〜4倍の処理速度。特にファイルI/OとHTTPサーバーが高速。package.jsonとの互換性もほぼ問題なし。',
  ...
  },
  {
    ...
    summary: 'SQLiteベースのD1がGA。Workers環境から直接SQLが叩けてコールドスタートもゼロに近い。コスト的にも魅力的な選択肢。',
  ...
  },
  {
    ...
    summary: 'Hybrid Search（BM25+ベクトル検索）、Re-ranking、Contextual Compressionを組み合わせた高精度RAGの実装パターン。',
