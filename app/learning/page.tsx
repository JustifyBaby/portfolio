  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 flex-wrap mb-1">
            ...
            <span style={{ fontSize: '5px', color: 'var(--gray)' }}>{entry.date}</span>
          </div>
          <p style={{ fontSize: '7px', color: 'var(--rpg-white)', lineHeight: 1.8 }}>
            {entry.title}
          </p>
        </div>
      </button>
      ...
      {open && (
        ...
        >
          <p style={{ fontSize: '6px', color: 'var(--gray)', lineHeight: 2.3, marginBottom: 10, marginTop: 8 }}>
            {entry.summary}
          </p>
  ...
  return (
    <PageShell>
      ...
      <div className="flex-1 overflow-y-auto animate-fadeIn flex flex-col gap-3">
        <SectionTitle>
          ◈ LEARNING LOG
          <span style={{ fontSize: '6px', color: 'var(--gray)', marginLeft: 8 }}>
          ...
          <div className="flex gap-1 flex-wrap">
            <button
              ...
              style={{
                ...
                background: !activeCategory ? 'rgba(240,192,64,.1)' : 'transparent',
                cursor: 'pointer',
        ...
        <div className="flex-1">
          {filtered.length === 0 ? (
            <div style={{ fontSize: '6px', color: 'var(--gray)', textAlign: 'center', padding: 24 }}>
        ...
        >
          <p style={{ fontSize: '5px', color: 'var(--gray)', lineHeight: 2.2 }}>
            新しいキャッチアップ内容は <span style={{ color: 'var(--gold)' }}>lib/data.ts</span> の
